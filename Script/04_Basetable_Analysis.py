...
for x_col in x_cols:
    for y_col in y_cols:
        ...
        g.savefig('./figures/dkewon/Basetable_Analysis/JointPlot'+'_'+str(x_col)+'_VS_'+str(y_col)+'.png', dpi=200)
###############################################################################    
...
for cat_col in cat_cols:
    for x_col in x_cols:
        for y_col in y_cols:
            ...
            g.savefig('./figures/dkewon/Basetable_Analysis/ScatterPlot_by_'+str(cat_col)+'_'+str(x_col)+'_VS_'+str(y_col)+'.png', dpi=200)
...
for cat_col in cat_cols:
    ...
    g.savefig('./figures/dkewon/Basetable_Analysis/PairPlot_by_'+str(cat_col)+'.png', dpi=200)
